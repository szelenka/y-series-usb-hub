...
{
    int8_t sensorLeft;         ///< Current state of the left sensor (HIGH/LOW)
    int8_t sensorRight;        ///< Current state of the right sensor (HIGH/LOW)
    int8_t pirSensor;          ///< Current state of the PIR motion sensor (HIGH/LOW)
    int8_t buttonRectangle;    ///< Current state of the rectangular button (HIGH/LOW, with pull-up: LOW when pressed)
    int8_t buttonCircle;       ///< Current state of the circular button (HIGH/LOW, with pull-up: LOW when pressed)
